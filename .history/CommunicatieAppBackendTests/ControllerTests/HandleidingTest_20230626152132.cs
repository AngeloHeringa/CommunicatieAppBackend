...
namespace CommunicatieAppBackendTests
{
    public class HandleidingControllerTests
    {
        ...
        public async Task Index_ReturnsViewResult()
        {
            ...
            handleidingenMockSet.As<IQueryable<Handleiding>>().Setup(m => m.Provider).Returns(handleidingen.AsQueryable().Provider);
            handleidingenMockSet.As<IQueryable<Handleiding>>().Setup(m => m.Expression).Returns(handleidingen.AsQueryable().Expression);
            handleidingenMockSet.As<IQueryable<Handleiding>>().Setup(m => m.ElementType).Returns(handleidingen.AsQueryable().ElementType);
            handleidingenMockSet.As<IQueryable<Handleiding>>().Setup(m => m.GetEnumerator()).Returns(handleidingen.GetEnumerator());
